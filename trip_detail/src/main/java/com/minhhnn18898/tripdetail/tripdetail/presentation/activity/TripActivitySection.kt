package com.minhhnn18898.tripdetail.tripdetail.presentation.activity
...
import com.minhhnn18898.tripdetail.tripdetail.presentation.trip.ITripActivityDisplay
import com.minhhnn18898.tripdetail.tripdetail.presentation.trip.TripActivityDateGroupHeader
import com.minhhnn18898.tripdetail.tripdetail.presentation.trip.TripActivityDisplayInfo
...
fun LazyListScope.renderTripActivitySection(
    ...
    if(activityInfoContentState is UiState.Error) {
        ...
        if(isEmpty) {
            item {
                DefaultEmptyView(
                    text = stringResource(id = com.minhhnn18898.tripdetail.R.string.add_your_activities),
                    modifier = Modifier
                        .height(100.dp)
                        .fillMaxWidth(),
            ...
            if(activityInfoContentState.data.size >= 3) {
                item {
                    CreateNewDefaultButton(
                        text = stringResource(id = com.minhhnn18898.tripdetail.R.string.add_new_activity),
...
private fun ActivityItemDescription(
    ...
    Row(
        ...
        if(photoPath.isEmpty()) {
            Image(
                painter = painterResource(com.minhhnn18898.tripdetail.R.drawable.default_empty_photo_trip_activity),
                contentDescription = "",
                contentScale = ContentScale.Crop,
                modifier = Modifier
                    .width(132.dp)
...
private fun ActivityScheduleInfo(
    ...
    Row(
        ...
        Icon(
            ...
            painter = painterResource(id = com.minhhnn18898.tripdetail.R.drawable.departure_board_24),
            contentDescription = "",
