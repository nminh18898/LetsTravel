...
class GetFlightInfoUseCase(private val repository: TripDetailRepository): AsyncUseCase<GetFlightInfoUseCase.Param, Flow<Result<Flow<List<FlightWithAirportInfo>>>>>() {
